...
// alef:hash:4edf0e2d59c6117e98c05e0cc8980a0c2be34439ce8642734cdbb24f0c3c0e7b
...
final class EmbeddingsTests: XCTestCase {
    func testEmbedTextsDifferentPreset() throws {
        ...
        let configObj = try embeddingConfigFromJson("{\"model\":{\"name\":\"multilingual\",\"type\":\"preset\"}}")
