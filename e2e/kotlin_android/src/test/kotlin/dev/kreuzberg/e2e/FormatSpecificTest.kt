...
// alef:hash:8efe7fc70897c1f5ce10e87b54154fa3a64412b14070fd723f054a0a5e2460a4
...
class FormatSpecificTest {
    ...
    fun testFormatPptx() = runBlocking {
        ...
        val result = Kreuzberg.extractFileSync("pptx/simple.pptx", "application/vnd.openxmlformats-officedocument.presentationml.presentation", null)
    }

    @Test
    fun testFormatXlsx() = runBlocking {
        // XLSX spreadsheet extraction using extract_file_sync
        val result = Kreuzberg.extractFileSync("xlsx/stanley_cups.xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", null)
    }
