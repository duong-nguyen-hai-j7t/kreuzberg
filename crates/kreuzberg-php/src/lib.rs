...
// alef:hash:fa5d2e7cfa5e602c8276e98cfc3ad5a27a287e1f21e5109d3d28bd9a040f8808
...
impl From<HierarchyConfig> for kreuzberg::HierarchyConfig {
    fn from(val: HierarchyConfig) -> Self {
        ...
        __result.k_clusters = val.k_clusters as usize;
...
impl From<ArchiveMetadata> for kreuzberg::ArchiveMetadata {
    fn from(val: ArchiveMetadata) -> Self {
        ...
        __result.total_size = val.total_size as u64;
...
impl From<BibtexMetadata> for kreuzberg::BibtexMetadata {
    fn from(val: BibtexMetadata) -> Self {
        ...
        __result.entry_count = val.entry_count as usize;
...
impl From<CitationMetadata> for kreuzberg::CitationMetadata {
    fn from(val: CitationMetadata) -> Self {
        ...
        __result.citation_count = val.citation_count as usize;
        __result.format = val.format;
        __result.authors = val.authors.into_iter().collect();
        __result.year_range = val.year_range.map(Into::into);
...
impl From<XlsxAppProperties> for kreuzberg::extraction::office_metadata::app_properties::XlsxAppProperties {
    fn from(val: XlsxAppProperties) -> Self {
        ...
        __result.hyperlinks_changed = val.hyperlinks_changed;
        __result.company = val.company;
        __result.worksheet_names = val.worksheet_names.into_iter().collect();
        __result
    }
}
...
impl From<PptxAppProperties> for kreuzberg::extraction::office_metadata::app_properties::PptxAppProperties {
    fn from(val: PptxAppProperties) -> Self {
        ...
        __result.slide_titles = val.slide_titles.into_iter().collect();
        __result
    }
}
