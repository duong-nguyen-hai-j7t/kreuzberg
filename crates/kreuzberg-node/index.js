...
const tryLoadBinding = () => {
  ...
  const targets = [
    ["linux", "x64", "gnu", "./kreuzberg-node.linux-x64-gnu.node", "@kreuzberg/node-linux-x64-gnu"],
    ["linux", "arm64", "gnu", "./kreuzberg-node.linux-arm64-gnu.node", "@kreuzberg/node-linux-arm64-gnu"],
    ["linux", "x64", "musl", "./kreuzberg-node.linux-x64-musl.node", "@kreuzberg/node-linux-x64-musl"],
    ["linux", "arm64", "musl", "./kreuzberg-node.linux-arm64-musl.node", "@kreuzberg/node-linux-arm64-musl"],
    ["darwin", "x64", null, "./kreuzberg-node.darwin-x64.node", "@kreuzberg/node-darwin-x64"],
    ["darwin", "arm64", null, "./kreuzberg-node.darwin-arm64.node", "@kreuzberg/node-darwin-arm64"],
    ["win32", "x64", null, "./kreuzberg-node.win32-x64-msvc.node", "@kreuzberg/node-win32-x64-msvc"],
    ["win32", "arm64", null, "./kreuzberg-node.win32-arm64-msvc.node", "@kreuzberg/node-win32-arm64-msvc"],
  ];
