 ...
 */
export declare const enum EntityCategory {
  /** A person's name. */
  Person = 'person',
...
export declare const enum NerBackendKind {
  /**
...
export declare const enum PiiCategory {
...
export declare const enum RedactionStrategy {
 ...
 */
export declare const enum RegionKind {
  /**
...
/** Summarisation strategy. */
export declare const enum SummaryStrategy {
  /**
 ...
 */
export declare const enum WhisperModel {
