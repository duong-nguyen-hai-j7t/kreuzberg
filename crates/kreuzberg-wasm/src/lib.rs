...
// alef:hash:de65bfbed3e0a80dae8d49ed418b20387b9ca99b6dc77708477d18618c2ade78
...
impl From<WasmMetadata> for kreuzberg::Metadata {
    fn from(val: WasmMetadata) -> Self {
        ...
        __result.additional = serde_wasm_bindgen::from_value(val.additional.clone()).unwrap_or_default();
        __result
    }
}
...
impl From<WasmHtmlMetadata> for kreuzberg::HtmlMetadata {
    fn from(val: WasmHtmlMetadata) -> Self {
        ...
        __result.open_graph = serde_wasm_bindgen::from_value(val.open_graph.clone()).unwrap_or_default();
        __result.twitter_card = serde_wasm_bindgen::from_value(val.twitter_card.clone()).unwrap_or_default();
        __result.meta_tags = serde_wasm_bindgen::from_value(val.meta_tags.clone()).unwrap_or_default();
...
impl From<WasmJatsMetadata> for kreuzberg::JatsMetadata {
    fn from(val: WasmJatsMetadata) -> Self {
        ...
        __result.history_dates = serde_wasm_bindgen::from_value(val.history_dates.clone()).unwrap_or_default();
...
impl From<WasmOcrElement> for kreuzberg::OcrElement {
    fn from(val: WasmOcrElement) -> Self {
        ...
        __result.geometry = serde_wasm_bindgen::from_value(val.geometry.clone()).unwrap_or_default();
        ...
        __result.backend_metadata = serde_wasm_bindgen::from_value(val.backend_metadata.clone()).unwrap_or_default();
        __result
    }
}
...
impl From<WasmTable> for kreuzberg::Table {
    fn from(val: WasmTable) -> Self {
        ...
        __result.cells = serde_wasm_bindgen::from_value(val.cells.clone()).unwrap_or_default();
