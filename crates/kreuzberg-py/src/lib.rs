...
// alef:hash:143896cd0034e05373c5e07d57e498da1952972e28e8c24123d4bafb49c2c7a5
...
impl From<ExtractionConfig> for kreuzberg::ExtractionConfig {
    fn from(val: ExtractionConfig) -> Self {
        ...
        __result.use_cache = val.use_cache;
        ...
        __result.extraction_timeout_secs = val.extraction_timeout_secs;
        __result.max_concurrent_extractions = val.max_concurrent_extractions;
        __result.result_format = val.result_format.into();
        ...
        __result.use_layout_for_markdown = val.use_layout_for_markdown;
        ...
        __result.cache_ttl_secs = val.cache_ttl_secs;
        __result.email = val.email.map(Into::into);
        __result.max_archive_depth = val.max_archive_depth;
...
impl From<ImageExtractionConfig> for kreuzberg::ImageExtractionConfig {
    fn from(val: ImageExtractionConfig) -> Self {
        ...
        __result.target_dpi = val.target_dpi;
        __result.max_image_dimension = val.max_image_dimension;
        __result.inject_placeholders = val.inject_placeholders;
        __result.auto_adjust_dpi = val.auto_adjust_dpi;
        __result.min_dpi = val.min_dpi;
        __result.max_dpi = val.max_dpi;
        __result.max_images_per_page = val.max_images_per_page;
        __result.classify = val.classify;
        __result
    }
}
...
impl From<HtmlOutputConfig> for kreuzberg::HtmlOutputConfig {
    fn from(val: HtmlOutputConfig) -> Self {
        ...
        __result.theme = val.theme.into();
        __result.class_prefix = val.class_prefix;
        __result.embed_css = val.embed_css;
        __result
    }
}
...
impl From<LayoutDetectionConfig> for kreuzberg::LayoutDetectionConfig {
    fn from(val: LayoutDetectionConfig) -> Self {
        ...
        __result.confidence_threshold = val.confidence_threshold;
        __result.apply_heuristics = val.apply_heuristics;
        __result.table_model = val.table_model.into();
        __result.acceleration = val.acceleration.map(Into::into);
        __result
    }
}
...
impl From<OcrConfig> for kreuzberg::OcrConfig {
    fn from(val: OcrConfig) -> Self {
        ...
        __result.paddle_ocr_config = val
            ...
            .as_ref()
            .and_then(|s| serde_json::from_str(s).ok());
        __result.backend_options = val.backend_options.as_ref().and_then(|s| serde_json::from_str(s).ok());
        ...
        __result.auto_rotate = val.auto_rotate;
...
impl From<PdfConfig> for kreuzberg::PdfConfig {
    fn from(val: PdfConfig) -> Self {
        ...
        __result.extract_images = val.extract_images;
        __result.extract_tables = val.extract_tables;
        ...
        __result.extract_annotations = val.extract_annotations;
        __result.top_margin_fraction = val.top_margin_fraction;
        __result.bottom_margin_fraction = val.bottom_margin_fraction;
        __result.allow_single_column_tables = val.allow_single_column_tables;
        __result.ocr_inline_images = val.ocr_inline_images;
        __result
    }
}
...
impl From<HierarchyConfig> for kreuzberg::HierarchyConfig {
    fn from(val: HierarchyConfig) -> Self {
        ...
        __result.enabled = val.enabled;
        __result.k_clusters = val.k_clusters;
        __result.include_bbox = val.include_bbox;
        __result.ocr_coverage_threshold = val.ocr_coverage_threshold;
        __result
    }
}
...
impl From<ChunkingConfig> for kreuzberg::ChunkingConfig {
    fn from(val: ChunkingConfig) -> Self {
        ...
        __result.max_characters = val.max_characters;
        __result.overlap = val.overlap;
        __result.trim = val.trim;
        __result.chunker_type = val.chunker_type.into();
        __result.embedding = val.embedding.map(Into::into);
        __result.preset = val.preset;
        __result.sizing = val.sizing.into();
        __result.prepend_heading_context = val.prepend_heading_context;
        __result.topic_threshold = val.topic_threshold;
        __result
    }
}
...
impl From<EmbeddingConfig> for kreuzberg::EmbeddingConfig {
    fn from(val: EmbeddingConfig) -> Self {
        ...
        __result.model = val.model.into();
        __result.normalize = val.normalize;
        __result.batch_size = val.batch_size;
        __result.show_download_progress = val.show_download_progress;
        __result.cache_dir = val.cache_dir.map(Into::into);
        __result.acceleration = val.acceleration.map(Into::into);
        __result.max_embed_duration_secs = val.max_embed_duration_secs;
        __result
    }
}
...
impl From<TreeSitterConfig> for kreuzberg::TreeSitterConfig {
    fn from(val: TreeSitterConfig) -> Self {
        ...
        __result.process = val.process.into();
        __result
    }
}
...
impl From<TreeSitterProcessConfig> for kreuzberg::TreeSitterProcessConfig {
    fn from(val: TreeSitterProcessConfig) -> Self {
        ...
        __result.structure = val.structure;
        __result.imports = val.imports;
        __result.exports = val.exports;
        __result.comments = val.comments;
        __result.docstrings = val.docstrings;
        __result.symbols = val.symbols;
        __result.diagnostics = val.diagnostics;
        __result.chunk_max_size = val.chunk_max_size;
        __result.content_mode = val.content_mode.into();
        __result
    }
}
...
impl From<TokenReductionConfig> for kreuzberg::TokenReductionConfig {
    fn from(val: TokenReductionConfig) -> Self {
        ...
        __result.level = val.level.into();
        __result.language_hint = val.language_hint;
        __result.preserve_markdown = val.preserve_markdown;
        __result.preserve_code = val.preserve_code;
        __result.semantic_threshold = val.semantic_threshold;
        __result.enable_parallel = val.enable_parallel;
        __result.use_simd = val.use_simd;
        __result.custom_stopwords = val.custom_stopwords.map(|m| m.into_iter().collect());
        __result.preserve_patterns = val.preserve_patterns.into_iter().collect();
        __result.target_reduction = val.target_reduction;
        __result.enable_semantic_clustering = val.enable_semantic_clustering;
        __result
    }
}
...
impl From<DocumentStructure> for kreuzberg::DocumentStructure {
    fn from(val: DocumentStructure) -> Self {
        ...
        __result.nodes = val.nodes.into_iter().map(Into::into).collect();
        __result.source_format = val.source_format;
        __result.relationships = val.relationships.into_iter().map(Into::into).collect();
        __result.node_types = val.node_types.into_iter().collect();
        __result
    }
}
...
impl From<LlmUsage> for kreuzberg::LlmUsage {
    fn from(val: LlmUsage) -> Self {
        ...
        __result.input_tokens = val.input_tokens;
        __result.output_tokens = val.output_tokens;
        __result.total_tokens = val.total_tokens;
...
impl From<TesseractConfig> for kreuzberg::TesseractConfig {
    fn from(val: TesseractConfig) -> Self {
        ...
        __result.language = val.language;
        __result.psm = val.psm;
        __result.output_format = val.output_format;
        __result.oem = val.oem;
        __result.min_confidence = val.min_confidence;
        __result.preprocessing = val.preprocessing.map(Into::into);
        __result.enable_table_detection = val.enable_table_detection;
        __result.table_min_confidence = val.table_min_confidence;
        __result.table_column_threshold = val.table_column_threshold;
        __result.table_row_threshold_ratio = val.table_row_threshold_ratio;
        __result.use_cache = val.use_cache;
        __result.classify_use_pre_adapted_templates = val.classify_use_pre_adapted_templates;
        __result.language_model_ngram_on = val.language_model_ngram_on;
        __result.tessedit_dont_blkrej_good_wds = val.tessedit_dont_blkrej_good_wds;
        __result.tessedit_dont_rowrej_good_wds = val.tessedit_dont_rowrej_good_wds;
        __result.tessedit_enable_dict_correction = val.tessedit_enable_dict_correction;
        __result.tessedit_char_whitelist = val.tessedit_char_whitelist;
        __result.tessedit_char_blacklist = val.tessedit_char_blacklist;
        __result.tessedit_use_primary_params_model = val.tessedit_use_primary_params_model;
        __result.textord_space_size_is_variable = val.textord_space_size_is_variable;
        __result.thresholding_method = val.thresholding_method;
        __result
    }
}
...
impl From<Metadata> for kreuzberg::Metadata {
    fn from(val: Metadata) -> Self {
        ...
        __result.extraction_duration_ms = val.extraction_duration_ms;
        __result.category = val.category;
        ...
        __result.output_format = val.output_format;
        __result.ocr_used = val.ocr_used;
        __result.additional = val
            .additional
            .into_iter()
            .map(|(k, v)| (k.into(), serde_json::from_str(&v).unwrap_or_default()))
            .collect();
...
impl From<EmailMetadata> for kreuzberg::EmailMetadata {
    fn from(val: EmailMetadata) -> Self {
        ...
        __result.to_emails = val.to_emails.into_iter().collect();
        __result.cc_emails = val.cc_emails.into_iter().collect();
        __result.bcc_emails = val.bcc_emails.into_iter().collect();
        __result.message_id = val.message_id;
        __result.attachments = val.attachments.into_iter().collect();
        __result
    }
}
...
impl From<ArchiveMetadata> for kreuzberg::ArchiveMetadata {
    fn from(val: ArchiveMetadata) -> Self {
        ...
        __result.file_count = val.file_count;
        __result.file_list = val.file_list.into_iter().collect();
        __result.total_size = val.total_size;
        __result.compressed_size = val.compressed_size;
        __result
    }
}
...
impl From<TextMetadata> for kreuzberg::TextMetadata {
    fn from(val: TextMetadata) -> Self {
        ...
        __result.line_count = val.line_count;
        __result.word_count = val.word_count;
        __result.character_count = val.character_count;
...
impl From<HtmlMetadata> for kreuzberg::HtmlMetadata {
    fn from(val: HtmlMetadata) -> Self {
        ...
        __result.title = val.title;
        __result.description = val.description;
        __result.keywords = val.keywords.into_iter().collect();
        ...
        __result.open_graph = val.open_graph.into_iter().map(|(k, v)| (k.into(), v.into())).collect();
        __result.twitter_card = val
            .twitter_card
            .into_iter()
            .map(|(k, v)| (k.into(), v.into()))
            .collect();
        __result.meta_tags = val.meta_tags.into_iter().map(|(k, v)| (k.into(), v.into())).collect();
        __result.headers = val.headers.into_iter().map(Into::into).collect();
        __result.links = val.links.into_iter().map(Into::into).collect();
        __result.images = val.images.into_iter().map(Into::into).collect();
        __result.structured_data = val.structured_data.into_iter().map(Into::into).collect();
        __result
    }
}
...
impl From<PptxMetadata> for kreuzberg::PptxMetadata {
    fn from(val: PptxMetadata) -> Self {
        ...
        __result.slide_count = val.slide_count;
        __result.slide_names = val.slide_names.into_iter().collect();
...
impl From<CsvMetadata> for kreuzberg::CsvMetadata {
    fn from(val: CsvMetadata) -> Self {
        ...
        __result.row_count = val.row_count;
        __result.column_count = val.column_count;
        __result.delimiter = val.delimiter;
        __result.has_header = val.has_header;
...
impl From<BibtexMetadata> for kreuzberg::BibtexMetadata {
    fn from(val: BibtexMetadata) -> Self {
        ...
        __result.entry_count = val.entry_count;
        __result.citation_keys = val.citation_keys.into_iter().collect();
        __result.authors = val.authors.into_iter().collect();
        __result.year_range = val.year_range.map(Into::into);
        __result.entry_types = val.entry_types.map(|m| m.into_iter().collect());
        __result
    }
}
...
impl From<CitationMetadata> for kreuzberg::CitationMetadata {
    fn from(val: CitationMetadata) -> Self {
        ...
        __result.citation_count = val.citation_count;
        __result.format = val.format;
        __result.authors = val.authors.into_iter().collect();
        __result.year_range = val.year_range.map(Into::into);
        __result.dois = val.dois.into_iter().collect();
        __result.keywords = val.keywords.into_iter().collect();
        __result
    }
}
...
impl From<FictionBookMetadata> for kreuzberg::FictionBookMetadata {
    fn from(val: FictionBookMetadata) -> Self {
        ...
        __result.genres = val.genres.into_iter().collect();
        __result.sequences = val.sequences.into_iter().collect();
...
impl From<JatsMetadata> for kreuzberg::JatsMetadata {
    fn from(val: JatsMetadata) -> Self {
        ...
        __result.history_dates = val
            .history_dates
            .into_iter()
            .map(|(k, v)| (k.into(), v.into()))
            .collect();
        __result.contributor_roles = val.contributor_roles.into_iter().map(Into::into).collect();
        __result
    }
}
...
impl From<OcrConfidence> for kreuzberg::OcrConfidence {
    fn from(val: OcrConfidence) -> Self {
        ...
        __result.recognition = val.recognition;
        __result
    }
}
...
impl From<OcrElement> for kreuzberg::OcrElement {
    fn from(val: OcrElement) -> Self {
        ...
        __result.text = val.text;
        __result.geometry = val.geometry.into();
        __result.confidence = val.confidence.into();
        __result.level = val.level.into();
        __result.rotation = val.rotation.map(Into::into);
        __result.page_number = val.page_number;
        __result.parent_id = val.parent_id;
        __result.backend_metadata = val
            .backend_metadata
            .into_iter()
            .map(|(k, v)| (k.into(), serde_json::from_str(&v).unwrap_or_default()))
            .collect();
...
impl From<Table> for kreuzberg::Table {
    fn from(val: Table) -> Self {
        ...
        __result.cells = val.cells.into_iter().collect();
        __result.markdown = val.markdown;
        __result.page_number = val.page_number;
        __result
    }
}
...
impl From<KeywordConfig> for kreuzberg::KeywordConfig {
    fn from(val: KeywordConfig) -> Self {
        ...
        __result.algorithm = val.algorithm.into();
        __result.max_keywords = val.max_keywords;
        __result.min_score = val.min_score;
        __result.language = val.language;
...
impl From<PaddleOcrConfig> for kreuzberg::PaddleOcrConfig {
    fn from(val: PaddleOcrConfig) -> Self {
        ...
        __result.language = val.language;
        __result.cache_dir = val.cache_dir.map(Into::into);
        __result.use_angle_cls = val.use_angle_cls;
        __result.enable_table_detection = val.enable_table_detection;
        __result.det_db_thresh = val.det_db_thresh;
        __result.det_db_box_thresh = val.det_db_box_thresh;
        __result.det_db_unclip_ratio = val.det_db_unclip_ratio;
        __result.det_limit_side_len = val.det_limit_side_len;
        __result.rec_batch_num = val.rec_batch_num;
        __result.padding = val.padding;
        __result.drop_score = val.drop_score;
        __result.model_tier = val.model_tier;
        __result
    }
}
