...
data class ExtractionConfig(
    ...
    fun needsImageData(): Boolean {
        ...
        val result_json = NativeMethods.ExtractionConfig_needs_image_data(this_json)
        return JsonTools.parse(result_json)
    }

    fun needsImageProcessing(): Boolean {
        val this_json = JsonTools.stringify(this)
        val result_json = NativeMethods.ExtractionConfig_needs_image_processing(this_json)
        return JsonTools.parse(result_json)
    }
