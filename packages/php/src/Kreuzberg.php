...
// alef:hash:9dcafae0e77da02f4eb325a363426abd2ad353a7ecfbac8d46ba9f13eeb163ad
...
final class Kreuzberg
{
    ...
    {
        if ($config === null) {
            $config = new ExtractionConfig(false, false, false, false, ResultFormat::Text, OutputFormat::Text, false, 10);
        }
